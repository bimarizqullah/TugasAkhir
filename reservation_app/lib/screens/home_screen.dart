...
class _HomeScreenState extends State<HomeScreen> {
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [_primarySoft, Colors.transparent],
  ...
  Widget _buildTableCard(dynamic table) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isNonaktif ? Colors.grey.shade100 : Colors.white, // 🔥 redup jika nonaktif
        ...
        border: Border.all(
            color: isNonaktif
                ? Colors.grey.shade300        // 🔥 abu jika nonaktif
                : isActive
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 13,
                        color: isNonaktif ? Colors.grey.shade400 : _textGrey),
                  ),
                ],
              ),
            ),
            // 🔥 Badge — nonaktif override semua
            isNonaktif
                ? _buildNonaktifBadge()
                : _buildStatusBadge(isActive),
          ]),

          // Detail sesi — hanya jika aktif DAN meja tidak nonaktif
